...
ACT["fab-open"] = () => {
    ...
    openSheet(`
      ...
      <div style="display:flex; flex-direction:column; gap:10px; padding-bottom:10px;">
         ...
         <button class="btn solid" style="justify-content:flex-start; min-height:60px; padding:0 20px;" onclick="closeSheet(); document.getElementById('cardioSheet').classList.add('on');">
            <span style="font-size:24px; margin-right:15px; width:30px; text-align:center;">🔥</span> 
            <div style="flex:1; text-align:left;">
