...
module.exports = async T => {
  ...
  a.ev('go("mais")'); a.q("[data-act=rem-open]").click(); T.ok(a.qa("[data-rem]").length === 11, "folha lista 11 lembretes");
  a.q('[data-remt="treino"]').value = "05:00"; a.q("[data-act=rem-gen]").click(); T.ok(a.w.__dl === "still-i-rise-lembretes.ics", "baixa o .ics");
