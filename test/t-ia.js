...
module.exports = async T => {
  ...
  T.ok(/você é a aura, uma assistente de ia/i.test(sys) && /profissional de saúde/.test(sys) && /2 ou 3 parágrafos/.test(sys) && /macros restantes/.test(sys), "regras: IA, até 3 parágrafos, não diagnostica, usa macros restantes");
  ...
  a.ev("SEC.gemKey = ''; render()"); T.ok(/enviada ao Google/.test(a.q("#lens").textContent), "sem chave, explica que chave e mensagens vão ao Google");
